...
const spelledDigits = [
  { spelled: "one", digit: "o1e" },
  { spelled: "two", digit: "t2o" },
  { spelled: "three", digit: "t3e" },
  { spelled: "four", digit: "f4r" },
  { spelled: "five", digit: "f5e" },
  { spelled: "six", digit: "s6x" },
  { spelled: "seven", digit: "s7n" },
  { spelled: "eight", digit: "e8t" },
  { spelled: "nine", digit: "n9e" },
];

export const replaceSpelledDigits = (line: string) => {
  return spelledDigits.reduce((prev, curr) => {
    return prev.replace(curr.spelled, curr.digit);
  }, line);
};

const calculateCalibrationValue = (input: string) => {
  return input
    .split("\n")
    .reduce((prev, curr) => prev + getNumberForString(curr), 0);
};

const calculateCalibrationPart2 = (input: string) => {
  return input
    .split("\n")
    .reduce(
...
const input = `sixsrvldfour4seven
...
console.log(calculateCalibrationPart2(input));
